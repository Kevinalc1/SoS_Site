        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
              Sobre a <span className="text-primary">Vereadora</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Suzi Racinha é uma vereadora comprometida com a transformação social em Paulista-PE. 
                Sua jornada política começou com o desejo genuíno de fazer a diferença na vida das 
                famílias que mais precisam de apoio e cuidado.
              </p>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Mãe atípica e defensora incansável dos direitos das pessoas com deficiência, 
                Suzi entende na prática os desafios enfrentados pelas famílias que cuidam de 
                crianças neurodivergentes e pessoas com necessidades especiais.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Através do projeto "SOS Tudo pelo Social", ela trabalha para criar uma rede 
