    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 bg-white p-8 rounded-lg shadow-md text-center">
          <h3 className="text-2xl font-bold text-gray-800 mb-4">Como configurar o Feed do Instagram</h3>
          <p className="text-gray-600 mb-6">
            Para exibir seu feed real do Instagram, siga estas etapas:
          </p>
          <ol className="text-left text-gray-700 space-y-4 mb-6 max-w-2xl mx-auto">
            <li>
              <strong>1.</strong> Crie uma conta de desenvolvedor no Facebook em <a href="https://developers.facebook.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">developers.facebook.com</a>
            </li>
            <li>
              <strong>2.</strong> Crie um aplicativo no Facebook Developer Dashboard
            </li>
            <li>
              <strong>3.</strong> Configure o produto "Instagram Basic Display" no seu aplicativo
            </li>
            <li>
              <strong>4.</strong> Adicione o Instagram Test User e gere um token de acesso de longa duração
            </li>
            <li>
              <strong>5.</strong> Substitua o valor da variável <code className="bg-gray-100 px-2 py-1 rounded">accessToken</code> neste componente pelo seu token
            </li>
          </ol>
          <p className="text-gray-600 mb-6">
            Para instruções detalhadas, consulte a <a href="https://developers.facebook.com/docs/instagram-basic-display-api/getting-started" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">documentação oficial</a>.
          </p>
        </div>
      </div>
    </section>
