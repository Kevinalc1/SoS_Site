        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">Vereadora Suzi Racinha</h3>
                <p className="text-primary font-medium">SOS Tudo pelo Social</p>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Trabalhando incansavelmente por uma sociedade mais inclusiva, justa e acolhedora 
              para todas as famílias de Paulista-PE.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm">(81) 99999-9999</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail size={16} className="text-primary" />
                <span className="text-gray-300 text-sm">contato@suziracinha.com.br</span>
              </div>
              <div className="flex items-start space-x-3">
                <MapPin size={16} className="text-primary mt-1" />
                <span className="text-gray-300 text-sm">
                  Câmara Municipal de Paulista<br />
                  Paulista - PE
                </span>
              </div>
            </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 Vereadora Suzi Racinha - SOS Tudo pelo Social. Todos os direitos reservados.
            </p>
